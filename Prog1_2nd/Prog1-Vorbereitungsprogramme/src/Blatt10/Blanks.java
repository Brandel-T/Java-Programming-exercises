...
//		String text = " Sie eine effiziente Methode searchBlanks(…),  die die Länge der längsten Sequenz von  Leerzeichen in einem   gegebenen String sucht und dabei möglichst wenig Zeichen im String untersucht (Hinweis: Das Programm sollte schneller werden, wenn die Länge der Sequenz von Leerzeichen zunimmt). Testen Sie Ihre Methode und geben Sie außerdem die Zahl der benötigten Vergleiche aus.";
		
		String text = "Beginnen   Sie in der linken     oberen Ecke  des Feldes";
//		String text = "Hallo la   planete  ";
